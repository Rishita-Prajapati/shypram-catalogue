...
export default function AdminDashboard() {
  ...
  const inStockProducts = products.filter((product) => product.availability === "in-stock").length
  const outOfStockProducts = products.filter((product) => product.availability === "out-of-stock").length
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <span className="font-bold text-muted-foreground">
                      {products.filter((p) => p.availability === "made-to-order").length}
                    </span>
                  </div>
