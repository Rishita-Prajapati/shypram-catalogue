-- Check current orders table structure and fix it
DO $$
BEGIN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'orders') THEN
        ...
        RAISE NOTICE 'Dropped existing orders table';
    END IF;
END $$;
...
RAISE NOTICE 'Orders table recreated successfully with correct structure';