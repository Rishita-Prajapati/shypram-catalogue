...
export function ProductCard({ product }: ProductCardProps) {
  ...
  const [cuttingQuantity, setCuttingQuantity] = useState("")
  ...
  const handleAddToCart = () => {
    const cartItem = {
      ...
      cuttingQuantity: parseInt(quantity) || 1,
    ...
    toast({
      title: "Added to Cart",
      description: `${parseInt(quantity) || 1}kg of ${product.name} added to cart`,
    })
  }
  ...
  return (
    <Card className="group interactive-card hover-lift hover:shadow-xl hover:shadow-primary/10 transition-all duration-300">
      <CardHeader className="p-0">
        <div className="relative aspect-square h-48 overflow-hidden rounded-t-lg bg-white p-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onBlur={(e) => {
              ...
              setQuantity(Math.max(1, value).toString())
            }}
